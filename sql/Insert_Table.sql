...
VALUES
('Technology', 'Latest news in the tech industry.'),
...
VALUES
('New Product Launch', '2022-01-01', '2022-01-31'),
...
INSERT INTO news (content, date, author_id) VALUES 
('This is the content of news 1 which has more than 10 words and should pass the check.', NOW(), 1),
...
INSERT INTO keyword (keyword, news_id)
VALUES 
('science', 1),
('technology', 1),
('health', 2),
...
VALUES
('John Doe', 'Great article, thanks for sharing!', '2022-01-01', 1),
