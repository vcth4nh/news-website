...
INSERT INTO news (title, content, date, author_id, category_id)
VALUES ('Title 1', 'This is the content of news 1 which has more than 10 words and should pass the check.', NOW(), 1,
        3),
       ('Title 2', 'Here is the content of news 2 which also has more than 10 words and will pass the check.', NOW(), 2,
        2),
       ('Title 3', 'News 3 has a long content with more than 10 words and is inserted into the database.', NOW(), 3, 1),
       ('Title 4', 'The fourth news has a lengthy content that is longer than 10 words and should be accepted.', NOW(),
        4, 4),
       ('Title 5', 'This is news 5 and its content is more than 10 words so it should be inserted into the table.',
        NOW(), 5, 2);
...
VALUES ('John Doe', 'Great article, thanks for sharing!', '2022-01-01', 2),
